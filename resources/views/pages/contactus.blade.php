...
@section('content')
    <div class="container mt-5">
        <div class="text-center">
            <img src="{{ asset('images/contact.webp') }}" alt="About Us" class="img-fluid shadow-sm"
                style="width: 100%; max-height: 450px; object-fit: cover;">
        </div>
        <div class="mt-5">
            <h2 class="text-primary fw-bold color-purple">Contact Us </h2>
            <div class="mt-3 pages-text">
                help.thestudyiq@gmail.com
            </div>
        </div>
        <div class="mt-5">
            <h2 class="text-primary fw-bold color-purple">Copy Right Issue</h2>
            <div class="mt-3 pages-text">
