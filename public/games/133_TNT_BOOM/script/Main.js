...
class Preloader extends Phaser.Scene {
    ...
    preload() {
		...
		this.load.audio('detonator_sound','assets/audio/detonator_sound.mp3');
		this.load.audio('dynamite_sound','assets/audio/dynamite_sound.mp3');
		this.load.audio('explode1','assets/audio/explode1.mp3');
		this.load.audio('explode2','assets/audio/explode2.mp3');
		this.load.audio('explode3','assets/audio/explode3.mp3');
